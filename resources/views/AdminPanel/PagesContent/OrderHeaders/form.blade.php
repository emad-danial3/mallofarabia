                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{(isset($code))?route('orderHeaders.update',$code):route('orderHeaders.store')}}"
                            ...
                            <div class="card-body">
                                ...
                                Current Discount ( <span id='currentDiscount'>0</span> % ) <i class="fa-solid fa-pen-to-square text-primary"></i>
                            </button>

                                                       </div>
                                                     <h5>After Discount ( <span id="totalHeaderAfterDiscount">0</span> LE)</h5>
                                                </div>
                                                <div class="col-md-2">
                        ...
                        <div class="row" id="invoice" style="    border: 1px solid #e7e7e7; margin-left: 3px; padding: 10px; border-radius: 5px; display: none">
                            ...
                            <div class="col-md-4 mt-2 mb-4">
                                ...
                                <form class="row g-4" method="POST" action="{{url('/payWithfawry') }}">
                                    ...
                                    <input type="hidden" name="order_id" id="order_online_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <datalist id="browsers">
                                        @foreach($users as $user)
                                            <option value="{{$user->full_name}}" id="{{$user->id}}" onclick="takeMyId({{$user->id}})">
                                        @endforeach
                                    </datalist>
                                </div>
                            </div>
                                    ...
                                    if (response.data) {
                                        if (response.data.data) {
                                            ...
                                            for (let iii = 0; iii < newus.length; iii++) {
                                                ...
                                                let option   = ' <option value="' + proObjff['full_name'] + '" id="' + proObjff['id'] + '"  onclick="takeMyId(' + proObjff['id'] + ')" >';
