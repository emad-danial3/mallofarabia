            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('sale_report_data_oracle')}}"> oracle sale report</a></li>
                    </ol>
                </div>
                <div class="col-sm-6">
                ...
                <table id="products-table" style="width: 100%" class="display table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @endif
                           ...
                           <th>{{ $invoice->oracle_total}}</th>
                           <th>{{ $invoice->trx_number}}</th>
    ...
    $('.send_again').on('click',function()
    {
     ...
     draw_table();
      ...
      $('#products-table').DataTable({
            ...
            var columnsToSum = [2,3,4,5, 6,7];
            columnsToSum.forEach(function(colIndex) {
            var total = api
                .column(colIndex)
                .data()
                .reduce(function(acc, val) {
                    var new_v = parseFloat(val)? parseFloat(val): 0;
                    return acc + new_v ;
                }, 0);
