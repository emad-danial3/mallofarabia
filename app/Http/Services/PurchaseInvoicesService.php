...
class PurchaseInvoicesService extends BaseServiceController
{
    private $PurchaseInvoiceRepository;
    private $PurchaseInvoiceLinesService;

    public function __construct( PurchaseInvoiceRepository $PurchaseInvoiceRepository, PurchaseInvoicesLinesService $PurchaseInvoiceLinesService)
    {
        $this->PurchaseInvoiceRepository = $PurchaseInvoiceRepository;
        $this->PurchaseInvoiceLinesService = $PurchaseInvoiceLinesService;
    ...
    {
        return $this->OrderRepository->find($order_id, ['id', 'total_order', 'user_id', 'created_for_user_id', 'order_type']);
    }
    ...
    {
        return $this->PurchaseInvoiceLinesService->getAllData($inputData);
    }
