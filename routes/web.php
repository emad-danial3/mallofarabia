...
Route::get('/', [HomeController::class, 'home'])->name('adminDashboard')->middleware(['auth:admin','roleChecker:super_admin,store_manager,manager_assistant,null,cashier,accountant']);
...
Route::get('/change_password', [AuthController::class, 'change_password'])->middleware(['auth:admin','roleChecker:super_admin,store_manager,manager_assistant,null,null,null']);
    ...
    Route::get('sale_report_data_oracle', [ReportsController::class, 'sale_report_data_oracle'])->name('sale_report_data_oracle')->middleware(['auth:admin','roleChecker:super_admin,store_manager,manager_assistant,null,null,accountant']);
