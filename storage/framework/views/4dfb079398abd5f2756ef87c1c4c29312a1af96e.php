                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="<?php echo e((isset($code))?route('orderHeaders.update',$code):route('orderHeaders.store')); ?>"
                            ...
                            <?php echo csrf_field(); ?>
                            <input type="hidden" id="min_required" value="<?php echo e($min_required); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <datalist id="browsers">
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value="<?php echo e($user->full_name); ?>" id="<?php echo e($user->id); ?>" onclick="takeMyId(<?php echo e($user->id); ?>)"><?php echo e($user->full_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </datalist>
                                </div>
                            </div>
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\emad\mall_of_arabia_store\resources\views/AdminPanel/PagesContent/OrderHeaders/storeorder.blade.php ENDPATH**/ ?>