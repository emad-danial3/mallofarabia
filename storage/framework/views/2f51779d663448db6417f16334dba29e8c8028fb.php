                ...
                <table id="orderHeadersTable" style="width: 100%" class="table table-bordered table-striped">
                    ...
                    <?php $__currentLoopData = $orderHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($row->total_order); ?>

                                <?php echo e($row->discount_amount ? '<span class="red discount">50</span>' : ''); ?></td>
                            <td><?php echo e(($row->client)?$row->client->name:''); ?></td>
                            <td><?php echo e(($row->client)?$row->client->name:''); ?></td>
                    
                            <td><?php echo e((isset($row->client))?$row->client->mobile:''); ?></td>
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bishoy.sobhy\Desktop\laravel\mall\mallofarabia\resources\views/AdminPanel/PagesContent/OrderHeaders/index.blade.php ENDPATH**/ ?>