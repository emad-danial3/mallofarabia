            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="<?php echo e(route('oracleInvoices.index')); ?>">Invoices</a></li>
                    </ol>
                </div>
                <div class="col-sm-12">
                    <div class="row mb-1 mt-2">
                        <div class="col-sm-5 row" style="border: 2px solid #f00;border-radius: 10px; padding: 5px">
                            ...
                            <div class="col-sm-5">
                                1
                                <a class="btn btn-outline-primary" href="<?php echo e(route('updateOracleInvoices')); ?>">Update
                                    Oracle
                                    Invoices</a>
                            </div>
                            <div class="col-sm-5">
                               2 <a class="btn btn-outline-success" href="<?php echo e(route('refreshOracleInvoices')); ?>">Refresh
                                    Invoices</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 row">
                            <h5 class="col-md-12">Total Invoices Count : <?php echo e($oracleInvoices->total()); ?></h5>
                            <h5 class="col-md-12">Orders Not Sent Oracle : <a class="btn btn-primary" href="<?php echo e(route('orderHeaders.index', ['send_t_o' => '0'])); ?>" target="_blank"><?php echo e($ordersCountNotSentToOracle); ?></a></h5>
                            <h5 class="col-md-12">Orders Sent Oracle no return :  <a class="btn btn-primary" href="<?php echo e(route('orderHeaders.index', ['send_t_o_not_return' => '1'])); ?>" target="_blank"><?php echo e($ordersCountSentToOracleNotReturn); ?></a></h5>
                        </div>


                    </div>

                    <form method="post" action="<?php echo e(route('oracleInvoices.ExportOracleInvoicesSheet')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <br>
                    <form method="get" action="<?php echo e(route('oracleInvoices.index')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6 mb-0">
                                ...
                                <select name="check_valid" class="form-control">
                                    ...
                                    <option value="valid" <?php if(app('request')->input('check_valid') == 'valid'): ?>selected <?php endif; ?> >Valid</option>
                                    <option value="notvalid" <?php if(app('request')->input('check_valid') == 'notvalid'): ?>selected <?php endif; ?> >Not Valid</option>
                                </select>
                            </div>
                           </div>
                            <div class="row col-3">
        ...
        <div class="card-body" style="overflow-x:scroll">
            <?php if(count($oracleInvoices) > 0): ?>
                <table id="orderHeadersTable" style="width: 100%" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $oracleInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($row->Order_ID); ?></td>
                            <td><?php echo e($row->web_order_number); ?></td>
                            <td><?php echo e($row->oracle_invoice_number); ?></td>
                            <td><?php echo e($row->wallet_status == 'only_fawry' ? "Fawry":"Cash"); ?></td>
                            <td><?php echo e($row->payment_code > 0 ?$row->payment_code:'Cash'); ?></td>
                            <td><?php echo e($row->total_order); ?></td>
                            <td><?php echo e($row->order_amount); ?></td>
                            <td>
                                <?php echo e($row->actual_amount); ?>

                                <?php if($row->actual_amount == 0): ?>
                                <p class="text-danger">Invoice Canceled</p>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($row->total_order_in_oracle); ?></td>
                            <td><?php echo e($row->total_order_out_oracle); ?></td>
                            <td><?php echo e(number_format($row->total_4u_min_oracle, 2, '.', '')); ?></td>
                            <?php if(($row->total_order-($row->total_order_in_oracle + $row->total_order_out_oracle)) >= -1 &&  ($row->total_order-($row->total_order_in_oracle+ $row->total_order_out_oracle)) <= 2 ): ?>
                                <td class="text-white" style="background-color:green "> Valid</td>
                            <?php else: ?>
                                <td class="text-white" style="background-color:red ">Not Valid</td>
                            <?php endif; ?>
                            <td><?php echo e(date('d-m-Y h:m a', strtotime($row->created_at))); ?></td>
                        </tr>
                ...
                <div class="pagination justify-content-center mt-2">
                    ...
                    <?php if(isset($oracleInvoices) && $oracleInvoices->lastPage() > 1): ?>
                        ...
                        ?>
                        <!-- first/previous -->
                            <?php if($oracleInvoices->currentPage() > 1): ?>
                                <li class="page-item">
                                    <a href="<?php echo e($oracleInvoices->url(1)."&type=".app('request')->input('type')); ?>" aria-label="First" class="page-link">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="<?php echo e($oracleInvoices->url($oracleInvoices->currentPage() - 1)."&type=".app('request')->input('type')); ?>" aria-label="Previous" class="page-link">
                        ...
                        <!-- links -->
                            <?php for($i = $from; $i <= $to; $i++): ?>
                                ...
                                <li class="page-item <?php echo e($isCurrentPage ? 'active' : ''); ?>" style="padding: 5px">
                                    <a class="page-link" href="<?php echo e(!$isCurrentPage ? $oracleInvoices->url($i)."&type=".app('request')->input('type') : ''); ?>">
                                        <?php echo e($i); ?>
                            ...
                            <?php endfor; ?>
                        <!-- next/last -->
                            <?php if($oracleInvoices->currentPage() < $oracleInvoices->lastPage()): ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo e($oracleInvoices->url($oracleInvoices->currentPage() + 1)."&type=".app('request')->input('type')); ?>" aria-label="Next">
                                        <span aria-hidden="true">&rsaquo;</span>
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo e($oracleInvoices->url($oracleInvoices->lastpage())."&type=".app('request')->input('type')); ?>" aria-label="Last">
...
<?php echo $__env->make('AdminPanel.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\emad\mall_of_arabia_store\resources\views/AdminPanel/PagesContent/oracleInvoices/index.blade.php ENDPATH**/ ?>